        ...
        try:
            ...
            if len(decoded_key) != 32:
                raise ValueError(
                    ...
                    f"Generate a valid key with: openssl rand -base64 44"
                )
            ...
            raise ValueError(
                f"ENCRYPTION_KEY is not valid base64. Generate with: openssl rand -base64 44. Error: {e}"
            )
        except InvalidToken as e:
            raise ValueError(
                f"ENCRYPTION_KEY is not a valid Fernet key. Generate with: openssl rand -base64 44. Error: {e}"
            )
