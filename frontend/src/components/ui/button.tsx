...
export function Button({ className, variant = 'default', size = 'default', ...props }: ButtonProps) {
  ...
  const variantClasses = {
    ...
    outline: 'border-2 border-[#c9cccf] bg-transparent text-[#202223] hover:bg-[#f6f6f7] hover:border-[#8c9196] focus:ring-[#008060] dark:border-[#2e2e2e] dark:bg-transparent dark:text-[#e3e3e3] dark:hover:bg-[#1a1a1a] dark:hover:border-[#404040]',
