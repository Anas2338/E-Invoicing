                ...
                {invoices.map((invoice) => (
                  <tr key={invoice.id} className="hover:bg-slate-50/60 transition-colors duration-150">
                    <td className="border-r-2 border-blue-200 pl-2 py-1.5 w-[11%]">
                      <div className="text-[11px] lg:text-[13px] xl:text-sm font-medium text-slate-700 truncate">{invoice.number}</div>
                    </td>
                    <td className="border-r-2 border-blue-200 px-1 py-1.5 w-[16%]">
                      <div className="text-[11px] lg:text-[13px] xl:text-sm font-medium text-slate-700 truncate">{invoice.fbrInvoiceNumber || '—'}</div>
                    </td>
