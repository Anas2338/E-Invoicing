    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Invoice Details</h1>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="text-base text-gray-900">{invoice?.external_id || 'N/A'}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-base text-gray-900">{invoice?.invoice_type || 'N/A'}</div>
            </div>
            <div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="text-base text-gray-900">{invoice?.buyer_business_name || 'N/A'}</div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">NTN/CNIC</label>
              <div className="text-base text-gray-900">{invoice?.buyer_ntn_cnic || 'N/A'}</div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Province</label>
              <div className="text-base text-gray-900">{invoice?.buyer_province || 'N/A'}</div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Registration Type</label>
              <div className="text-base text-gray-900">{invoice?.buyer_registration_type || 'N/A'}</div>
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">Address</label>
              <div className="text-base text-gray-900">{invoice?.buyer_address || 'N/A'}</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Business Name</label>
              <div className="text-base text-gray-900">{invoice?.seller_business_name || 'N/A'}</div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">NTN/CNIC</label>
              <div className="text-base text-gray-900">{invoice?.seller_ntn_cnic || 'N/A'}</div>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Province</label>
              <div className="text-base text-gray-900">{invoice?.seller_province || 'N/A'}</div>
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">Address</label>
              <div className="text-base text-gray-900">{invoice?.seller_address || 'N/A'}</div>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex justify-between text-base">
              <span className="text-gray-600">Subtotal (Excluding Tax):</span>
      ...
      {invoice?.fbr_invoice_number && (
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">FBR Invoice Number</label>
                <div className="text-base text-gray-900 font-mono">{invoice.fbr_invoice_number}</div>
              </div>
