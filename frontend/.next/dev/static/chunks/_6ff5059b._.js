...
function ValidatedInvoicesPage() {
    ...
    const handleBulkPost = async ()=>{
        ...
        try {
            ...
            alert(`${successCount} out of ${selectedInvoices.length} invoices posted successfully`);
            setSelectedInvoices([]);
        } catch (error) {
            console.error('Error posting invoices:', error);
            alert('Failed to post invoices. Please try again.');
        }
    };
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_6ff5059b._.js.map