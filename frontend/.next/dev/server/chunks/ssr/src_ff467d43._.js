...
function ForgotPasswordPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (response.ok) {
                setIsSubmitted(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Password reset instructions sent to your email');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.detail || 'Failed to send reset email');
            }
        } catch (error) {
            console.error('Error requesting password reset:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to send reset email. Please try again.');
        } finally{
...
//# sourceMappingURL=src_ff467d43._.js.map