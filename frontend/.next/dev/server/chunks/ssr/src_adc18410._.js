...
function EditInvoicePage() {
    ...
    const fetchInvoice = async ()=>{
        try {
            setLoading(true);
            setError(null);
            // Fetch invoice data from backend using the list method
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invoiceService"].getInvoices({
                page: 1,
                limit: 100
            });
            // The response has a 'data' property containing the invoices array
...
//# sourceMappingURL=src_adc18410._.js.map